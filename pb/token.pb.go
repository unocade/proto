...
const file_token_proto_rawDesc = "" +
	...
	"\busername\x18\x03 \x01(\tR\busername2\xa6\x01\n" +
	"\fTokenService\x12J\n" +
	"\rGenerateToken\x12\x1b.token.GenerateTokenRequest\x1a\x1c.token.GenerateTokenResponse\x12J\n" +
	"\rValidateToken\x12\x1b.token.ValidateTokenRequest\x1a\x1c.token.ValidateTokenResponseB\aZ\x05./;pbb\x06proto3"
