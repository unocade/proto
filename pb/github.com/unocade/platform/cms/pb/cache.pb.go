...
const file_cache_proto_rawDesc = "" +
	...
	"\x0fRegisterService\x12\x1e.common.RegisterServiceRequest\x1a\x1f.common.RegisterServiceResponseB'Z%github.com/unocade/platform/cms/pb;pbb\x06proto3"
...
var file_cache_proto_goTypes = []any{
	...
	(*__.HealthCheckRequest)(nil),      // 17: common.HealthCheckRequest
	(*__.RegisterServiceRequest)(nil),  // 18: common.RegisterServiceRequest
	(*__.HealthCheckResponse)(nil),     // 19: common.HealthCheckResponse
	(*__.RegisterServiceResponse)(nil), // 20: common.RegisterServiceResponse
}
