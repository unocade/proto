...
type CacheServiceClient interface {
	...
	// ---------------- Health ----------------
	HealthCheck(ctx context.Context, in *__.HealthCheckRequest, opts ...grpc.CallOption) (*__.HealthCheckResponse, error)
	RegisterService(ctx context.Context, in *__.RegisterServiceRequest, opts ...grpc.CallOption) (*__.RegisterServiceResponse, error)
}
...
func (c *cacheServiceClient) HealthCheck(ctx context.Context, in *__.HealthCheckRequest, opts ...grpc.CallOption) (*__.HealthCheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(__.HealthCheckResponse)
...
func (c *cacheServiceClient) RegisterService(ctx context.Context, in *__.RegisterServiceRequest, opts ...grpc.CallOption) (*__.RegisterServiceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(__.RegisterServiceResponse)
...
type CacheServiceServer interface {
	...
	// ---------------- Health ----------------
	HealthCheck(context.Context, *__.HealthCheckRequest) (*__.HealthCheckResponse, error)
	RegisterService(context.Context, *__.RegisterServiceRequest) (*__.RegisterServiceResponse, error)
...
func (UnimplementedCacheServiceServer) HealthCheck(context.Context, *__.HealthCheckRequest) (*__.HealthCheckResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HealthCheck not implemented")
}
func (UnimplementedCacheServiceServer) RegisterService(context.Context, *__.RegisterServiceRequest) (*__.RegisterServiceResponse, error) {
...
func _CacheService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CacheServiceServer).HealthCheck(ctx, req.(*__.HealthCheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CacheService_RegisterService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(__.RegisterServiceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CacheServiceServer).RegisterService(ctx, req.(*__.RegisterServiceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
